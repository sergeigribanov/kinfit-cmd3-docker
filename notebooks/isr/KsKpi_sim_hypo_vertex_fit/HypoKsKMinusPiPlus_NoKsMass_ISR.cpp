...
/**
 * @file HypoKsKMinusPiPlus_NoKsMass_ISR.cpp
 *
 * @brief Implementation of HypoKsKMinusPiPlus_NoKsMass_ISR methods
 *
 * @ingroup KFCmd
 *
...
#include "HypoKsKMinusPiPlus_NoKsMass_ISR.hpp"

using namespace kfcmd::hypos;

HypoKsKMinusPiPlus_NoKsMass_ISR::HypoKsKMinusPiPlus_NoKsMass_ISR(double energy, double magnetField,
...
HypoKsKMinusPiPlus_NoKsMass_ISR::~HypoKsKMinusPiPlus_NoKsMass_ISR() {}
