...
Histograms::Histograms() {
 ...
 // chi2_vs_q = new TH2F("chi2_vs_q", "", 1024, 0, 70, 1024, -40, 40);
  ...
  qHist = new TH1F("qhist", "", 1024, -50, 200);
  chi2_vs_q = new TH2F("chi2_vs_q", "", 1024, 0, 400, 1024, -50, 200);
 ...
 vtx0_dx = new TH1F("vtx0_dx", "", 1024, -20, 20);
 vtx0_dy = new TH1F("vtx0_dy", "", 1024, -20, 20);
 ...
 vtx0_dx_pull = new TH1F("vtx0_dx_pull", "", 1024, -20, 20);
 vtx0_dy_pull = new TH1F("vtx0_dy_pull", "", 1024, -20, 20);
