    ...
    for (int im = 0; im < 2; ++im) {
      ...
      for (int ip = 2; ip < 4; ++ip) {
        ...
        if (tchi2_plus < kf_chi2_plus) {
          ...
          // v_sigma_z_vtx0_plus = std::sqrt(std::fabs(hypo_plus.getVertexCov("vtx0", kfbase::core::VERTEX_Z)));
          // v_sigma_x_vtx1_plus = std::sqrt(std::fabs(hypo_plus.getVertexCov("vtx1", kfbase::core::VERTEX_X)));
          // v_sigma_y_vtx1_plus = std::sqrt(std::fabs(hypo_plus.getVertexCov("vtx1", kfbase::core::VERTEX_Y)));
          // v_sigma_z_vtx1_plus = std::sqrt(std::fabs(hypo_plus.getVertexCov("vtx1", kfbase::core::VERTEX_Z)));
    ...
    for (int im = 0; im < 2; ++im) {
      ...
      for (int ip = 2; ip < 4; ++ip) {
        ...
        if (tchi2_minus < kf_chi2_minus) {
          ...
          // v_sigma_z_vtx0_minus = std::sqrt(std::fabs(hypo_minus.getVertexCov("vtx0", kfbase::core::VERTEX_Z)));
          // v_sigma_x_vtx1_minus = std::sqrt(std::fabs(hypo_minus.getVertexCov("vtx1", kfbase::core::VERTEX_X)));
          // v_sigma_y_vtx1_minus = std::sqrt(std::fabs(hypo_minus.getVertexCov("vtx1", kfbase::core::VERTEX_Y)));
          // v_sigma_z_vtx1_minus = std::sqrt(std::fabs(hypo_minus.getVertexCov("vtx1", kfbase::core::VERTEX_Z)));
