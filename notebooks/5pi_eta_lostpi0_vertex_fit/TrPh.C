...
void TrPh::Loop(const std::string& outpath, double magneticField) {
  ...
  fChain->GetEntry(0);
  kfcmd::hypos::Hypo4ChPionsLostPi0_EtaMass hypo(2.e-3 * emeas, magneticField);
  kfcmd::hypos::Hypo4PiVertex hypo_vertex(2.e-3 * emeas, magneticField);
  kfcmd::hypos::Hypo4ChPionsLostPi0_EtaMass hypo_tmp(2.e-3 * emeas, magneticField);
