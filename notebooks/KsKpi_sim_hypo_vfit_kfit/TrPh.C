...
void TrPh::setupOutputBranches_(TTree* tree) {
  ...
  tree->Branch("kf_2stp_mks", &kf_2stp_mks_, "kf_2stp_mks/D");
...
void TrPh::Loop(const std::string& outpath, double magneticField) {
  ...
  kfcmd::hypos::HypoKsKPlusPiMinus_NoKsMass hypo_plus_tmp(2.e-3 * emeas, magneticField);
  kfcmd::hypos::HypoKsKMinusPiPlus_NoKsMass hypo_minus_tmp(2.e-3 * emeas, magneticField);
  ...
  double kf_2stp_mks_plus = 0;
  double kf_2stp_mks_minus = 0;
  ...
  for (Long64_t jentry = 0; jentry < nentries; jentry++) {
    ...
    hypo_plus_tmp.setBeamXY(xbeam, ybeam);
    hypo_plus_tmp.fixVertexParameter("vtx0", 0, xbeam);
    hypo_plus_tmp.fixVertexParameter("vtx0", 1, ybeam);
    hypo_minus_tmp.setBeamXY(xbeam, ybeam);
    hypo_minus_tmp.fixVertexParameter("vtx0", 0, xbeam);
    hypo_minus_tmp.fixVertexParameter("vtx0", 1, ybeam);
    ...
    for (int im = 0; im < 2; ++im) {
      ...
      for (int ip = 2; ip < 4; ++ip) {
        ...
        hypo_plus_tmp.fixVertexParameter("vtx0", 2, hypo_plus.getFinalVertex("vtx0").Z());
        hypo_plus_tmp.fixVertexParameter("vtx1", 0, hypo_vertex.getFinalVertex("vtx1").X());
        hypo_plus_tmp.fixVertexParameter("vtx1", 1, hypo_vertex.getFinalVertex("vtx1").Y());
        hypo_plus_tmp.fixVertexParameter("vtx1", 2, hypo_vertex.getFinalVertex("vtx1").Z());
        hypo_plus_tmp.fillTrack("pi-_1", trackIndices_[im], *this);
        hypo_plus_tmp.fillTrack("pi-_0", trackIndices_[1 - im], *this);
        hypo_plus_tmp.fillTrack("pi+_1", trackIndices_[ip], *this);
        hypo_plus_tmp.fillTrack("k+", trackIndices_[5 - ip], *this);
        hypo_plus_tmp.optimize();
        ...
        if (tchi2_plus < kf_chi2_plus) {
          ...
          kf_2stp_mks_plus = hypo_plus_tmp.getFinalMomentum(decaypds_).M();
    ...
    for (int im = 0; im < 2; ++im) {
      ...
      for (int ip = 2; ip < 4; ++ip) {
        ...
        hypo_minus_tmp.fixVertexParameter("vtx0", 2, hypo_minus.getFinalVertex("vtx0").Z());
        hypo_minus_tmp.fixVertexParameter("vtx1", 0, hypo_vertex.getFinalVertex("vtx1").X());
        hypo_minus_tmp.fixVertexParameter("vtx1", 1, hypo_vertex.getFinalVertex("vtx1").Y());
        hypo_minus_tmp.fixVertexParameter("vtx1", 2, hypo_vertex.getFinalVertex("vtx1").Z());
        hypo_minus_tmp.fillTrack("pi-_1", trackIndices_[im], *this);
        hypo_minus_tmp.fillTrack("k-", trackIndices_[1 - im], *this);
        hypo_minus_tmp.fillTrack("pi+_1", trackIndices_[ip], *this);
        hypo_minus_tmp.fillTrack("pi+_0", trackIndices_[5 - ip], *this);
        hypo_minus_tmp.optimize();
        ...
        if (tchi2_minus < kf_chi2_minus) {
          ...
          kf_2stp_mks_minus = hypo_minus_tmp.getFinalMomentum(decaypds_).M();
    ...
    if (flag_minus) {
      ...
      kf_2stp_mks_ = kf_2stp_mks_minus;
