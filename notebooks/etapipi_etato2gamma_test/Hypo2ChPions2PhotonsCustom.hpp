...
#ifndef _KFCmd_Hypo2ChPions2PhotonsCustom_HPP_
#define _KFCmd_Hypo2ChPions2PhotonsCustom_HPP_
...
namespace kfcmd {
  namespace hypos {
     ...
     */
    class Hypo2ChPions2PhotonsCustom : public kfcmd::core::Hypothesis {
    public:
      //! A constructor
      /*!
       ...
       */
      Hypo2ChPions2PhotonsCustom(double, double, long = 20, double = 1.e-4);
      //! A destructor
      virtual ~Hypo2ChPions2PhotonsCustom();
    };
  } // namespace core
}  // namespace kfcmd
