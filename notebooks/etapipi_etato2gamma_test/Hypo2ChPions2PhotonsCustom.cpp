...
/**
 * @file Hypo2ChPions2PhotonsCustom.cpp
 *
 * @brief Implementation of Hypo2ChPions2PhotonsCustom methods
 *
 * @ingroup KFCmd
 *
...
#include "Hypo2ChPions2PhotonsCustom.hpp"

using namespace kfcmd::hypos;

Hypo2ChPions2PhotonsCustom::Hypo2ChPions2PhotonsCustom(double energy,
...
Hypo2ChPions2PhotonsCustom::~Hypo2ChPions2PhotonsCustom() {}
