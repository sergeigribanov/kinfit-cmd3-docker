...
Histograms::Histograms() {
 ...
 sigma_x_vtx0 = new TH1F("sigma_x_vtx0", "", 1024, 0, 2);
 sigma_y_vtx0 = new TH1F("sigma_y_vtx0", "", 1024, 0, 2);
 ...
 vtx0_dx = new TH1F("vtx0_dx", "", 512, -0.2, 0.2);
 vtx0_dy = new TH1F("vtx0_dy", "", 512, -0.2, 0.2);
 vtx0_dz = new TH1F("vtx0_dz", "", 512, -1, 1);
 vtx1_dx = new TH1F("vtx1_dx", "", 512, -0.2, 0.2);
 vtx1_dy = new TH1F("vtx1_dy", "", 512, -0.2, 0.2);
 vtx1_dz = new TH1F("vtx1_dz", "", 512, -1, 1);
 vtx0_dx_pull = new TH1F("vtx0_dx_pull", "", 512, -6, 6);
 vtx0_dy_pull = new TH1F("vtx0_dy_pull", "", 512, -6, 6);
 vtx0_dz_pull = new TH1F("vtx0_dz_pull", "", 512, -6, 6);
 vtx1_dx_pull = new TH1F("vtx1_dx_pull", "", 512, -6, 6);
 vtx1_dy_pull = new TH1F("vtx1_dy_pull", "", 512, -6, 6);
 vtx1_dz_pull = new TH1F("vtx1_dz_pull", "", 512, -6, 6);
}
...
void TrPh::refitKPlus_(kfcmd::hypos::HypoKsKPlusPiMinus_NoKsMass *hypo,
  ...
  hypo->setInitialParticleParams("k+",
                                 gaussgen::gaussgen_nfirst(5, params_.parChPlus0,
                                                           ...
                                                           &rnd_));
  hypo->setInitialVertexParams("vtx0", gaussgen::gaussgen_nfirst(2, params_.parVtx0,
                                                                 params_.invCovVtx0,
                                                                 &rnd_));
  ...
  hists->sigma_x_vtx0->Fill(sigma_x_vtx0_);
  hists->sigma_y_vtx0->Fill(sigma_y_vtx0_);
  ...
  hists->vtx0_dx->Fill(kf_vtx0_[0] - sim_ee_vtx_[0]);
  hists->vtx0_dy->Fill(kf_vtx0_[1] - sim_ee_vtx_[1]);
  ...
  hists->vtx0_dx_pull->Fill((kf_vtx0_[0] - sim_ee_vtx_[0]) / sigma_x_vtx0_);
  hists->vtx0_dy_pull->Fill((kf_vtx0_[1] - sim_ee_vtx_[1]) / sigma_y_vtx0_);
